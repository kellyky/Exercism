class Scrabble
  # Still not the 'real' next iteration - just putting things right following a git stash
  # Renamed from TILE_POINTS
  ENGLISH_TILES = {
    A: 1, N: 1,
    B: 3, O: 1,
    C: 3, P: 3,
  ...
  def initialize(letters, tile_set = ENGLISH_TILES)
    # @letters renamed from @tiles to avoid confusion with @tile_set
